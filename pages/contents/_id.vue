    ...
    <div class="content">
      <div class="content-title flex-aling-center">
        <h2>{{ content.title }}</h2>
			...
			<div class="grid flex-aling-center" v-if="content.embeddable || !content.description">
				<div class="content-embeddable">
					...
					<img :src="content.url" v-if="content.type == 'image'" width="420" height="420" >
			...
			<div class="content-download" v-if="content.allow_download">
				<button class="btn btn-primary"
								@click="fileDownload(content.url)">
					Download
				</button>
			</div>
...
export default {
  ...
  async created() {
	...
	methods:{
        ...
        link.href = url;
        link.setAttribute('download', "NFSe.jpg");
